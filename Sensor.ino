...
void ShowValue_Gyro() {
  setAngleOffset();
  lcdSetTextSize(2);
  lcdPrintText(32, 10, "IMU TEST", 0xf800);
  lcdSetTextSize(1);
  lcdPrintText(35, 40, " ROLL:", 0xffff);
  lcdPrintText(35, 60, "PITCH:", 0xffff);
  lcdPrintText(35, 80, "  YAW:", 0xffff);
  while (1) {
    lcdPrintText(85, 40, "       ", 0xffff);
    lcdPrintText(85, 40, String(angleRead(ROLL)), 0xffff);
    lcdPrintText(85, 60, "       ", 0xffff);
    lcdPrintText(85, 60, String(angleRead(PITCH)), 0xffff);
    lcdPrintText(85, 80, "       ", 0xffff);
    lcdPrintText(85, 80, String(angleRead(YAW)), 0xffff);
  }
}
